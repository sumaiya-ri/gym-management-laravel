        ...
        <form action="{{ route('admin.services.update', $service->id) }}" method="POST">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $service->name) }}" class="w-full border-gray-200 rounded-xl focus:ring-purple-500 focus:border-purple-500 shadow-sm p-4" placeholder="e.g. Yoga, HIIT, Pilates" required>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" class="w-full border-gray-200 rounded-xl focus:ring-purple-500 focus:border-purple-500 shadow-sm p-4" placeholder="Briefly describe what this service is about...">{{ old('description', $service->description) }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="duration" id="duration" value="{{ old('duration', $service->duration) }}" class="w-full border-gray-200 rounded-xl focus:ring-purple-500 focus:border-purple-500 shadow-sm p-4" required>
