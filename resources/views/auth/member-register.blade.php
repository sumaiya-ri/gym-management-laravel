        ...
        <div class="w-full sm:max-w-md mt-6 px-8 py-10 bg-white shadow-2xl overflow-hidden sm:rounded-3xl border border-purple-100">
            ...
            <form method="POST" action="{{ route('member.register') }}" class="space-y-4">
                ...
                <div class="mt-4">
                    ...
                    <x-input id="password" class="block w-full border-gray-200 focus:border-purple-500 focus:ring-purple-500 rounded-xl px-4 py-3 bg-white text-gray-700" type="password" name="password" required autocomplete="new-password" placeholder="••••••••" />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <x-input id="password_confirmation" class="block w-full border-gray-200 focus:border-purple-500 focus:ring-purple-500 rounded-xl px-4 py-3 bg-white text-gray-700" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" />
                </div>
                ...
                <!-- Google OAuth Button -->
                <div>
                    <button type="submit" formaction="{{ route('auth.google.redirect.post') }}" class="flex items-center justify-center gap-3 w-full py-4 border border-gray-300 rounded-2xl font-bold text-gray-700 bg-white hover:bg-gray-50 active:scale-95 transition-all shadow-sm">
